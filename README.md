...
harness/approvals/   the approvals host: cards, decisions, the effects dispatcher
...
choose where a human is talked to, and the approvals host holds no transport of its own. An
**identity plug-in** is loaded the same way: set `HARNESS_IDENTITY` to choose who resolves a
person to a principal, and the kernel binds that principal to every run before the model sees
anything.
...
| [docs/runbook.md](docs/runbook.md)               | operating it: audit, effects, reconciliation, storage, the approvals host, onboarding                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| package READMEs                                  | [shared](harness/shared/README.md), [pack-api](harness/pack-api/README.md), [surface-api](harness/surface-api/README.md), [identity-api](harness/identity-api/README.md), [db](harness/db/README.md), [gateway](harness/gateway/README.md), [core-tools](harness/core-tools/README.md), [approvals](harness/approvals/README.md), [files](harness/files/README.md), [surface-slack](surfaces/slack/README.md), [surface-memory](surfaces/memory/README.md), [identity-static](identities/static/README.md), [evals](evals/README.md), [pack-healthcare](packs/healthcare/README.md), [pack-stories](packs/stories/README.md), [scripts](scripts/README.md) |
