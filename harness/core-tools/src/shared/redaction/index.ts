 ...
 * text on its way to Slack — does not have to import the whole core-tools barrel and inherit
 ...
 */
export { containsRestrictedPattern, isValidDea, type RestrictedKind } from './patterns.js';
